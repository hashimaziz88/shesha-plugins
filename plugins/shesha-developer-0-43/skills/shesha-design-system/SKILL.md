...
| Concern | Skill |
|---|---|
| Ingest design, plan, orchestrate, verify | `shesha-developer-0-43:shesha-claude-designer` |
| Comprehend design → measured layout blueprint + placement verification | `shesha-developer-0-43:shesha-design-comprehension` |
| Build structure, CRUD, validate, push | `shesha-developer-0-43:shesha-form-edit` |
