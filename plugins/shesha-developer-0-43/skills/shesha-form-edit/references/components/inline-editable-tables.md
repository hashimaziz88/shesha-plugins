...
```json
{
  ...
  "editComponent":   { "type": "textField", "settings": { "type": "textField", "version": 5, "editMode": "inherited", "hideLabel": true, "label": "", "textType": "text", "validate": {} } },
  "createComponent": { "type": "textField", "settings": { "type": "textField", "version": 5, "editMode": "inherited", "hideLabel": true, "label": "", "textType": "text", "validate": {} } }
}
```
...
"editComponent": { "type": "autocomplete", "settings": {
  "type": "autocomplete", "version": 6, "editMode": "inherited", "hideLabel": true, "label": "",
  "dataSourceType": "entitiesList",
  "entityType": "Shesha.Domain.Person",  // 0.43: full-class-name STRING
  "mode": "single", "useRawValues": false, "validate": {}
} }
```

`numberField` (`version` 4) and `dateField` (`version` 5) follow the same pattern. **Use the
...
In `@shesha-io/reactjs 0.43.x`, a **reference-list dropdown used as an inline-grid editor shows
