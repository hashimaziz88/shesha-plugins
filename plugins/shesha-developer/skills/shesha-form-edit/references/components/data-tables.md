...
```json
{
  "id": "...",
  "type": "dataContext",
  "propertyName": "wardsContext",
  "componentName": "wardsContext",
  "sourceType": "Entity",
  ...
  "components": [
    { "id": "...", "type": "datatable.quickSearch" },
    {
      ...
      "formId": { "module": "His.Facilities", "name": "ward-card" },
      "formType": "Table",
      "orientation": "wrap",
      "listItemWidth": 0.25,
      "selectionMode": "none"
