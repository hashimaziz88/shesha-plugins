...
Proven on live fleet rollouts: a multi-form header/KIB redesign via one piloted transform script, and a separate multi-form create-form fix in one scripted pass with field-set assertions — both audited to 0 issues pre- and post-push.
