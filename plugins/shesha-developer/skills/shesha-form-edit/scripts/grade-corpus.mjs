 ...
 *
 * --seeds also grades the bundled assets/examples/*.json + assets/exemplars/*.json
 * seed forms as a SEPARATE cohort (these are NOT
...
function loadSeedForms() {
  const out = [];
  for (const dir of [EXAMPLES_DIR, EXEMPLARS_DIR]) {
    let files;
    try {
