...
**Do NOT use for:**
- Standard data forms — a table/list of an entity, create/edit/detail views, CRUD dialogs → `shesha-developer:shesha-form-edit` (its pipeline includes validation, guardrails, and theme tokens baked in at compile time).
