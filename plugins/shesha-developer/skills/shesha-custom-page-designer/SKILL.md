...
**Do NOT use for:**
- Standard data forms — a table/list of an entity, create/edit/detail views, CRUD dialogs → `shesha-developer:shesha-form-edit` (its pipeline includes validation, guardrails, and the default theme baked in at compile).
